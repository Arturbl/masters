...
# Drop MySQL tables
#mysql -h $MYSQL_SERVER -P $MYSQL_PORT -u $MYSQL_USERNAME -p$MYSQL_PASSWORD -D $MYSQL_DATABASE -e "DROP TABLE IF EXISTS benefits"
#mysql -h $MYSQL_SERVER -P $MYSQL_PORT -u $MYSQL_USERNAME -p$MYSQL_PASSWORD -D $MYSQL_DATABASE -e "DROP TABLE IF EXISTS salaries"
#mysql -h $MYSQL_SERVER -P $MYSQL_PORT -u $MYSQL_USERNAME -p$MYSQL_PASSWORD -D $MYSQL_DATABASE -e "DROP TABLE IF EXISTS employee_counts"
#mysql -h $MYSQL_SERVER -P $MYSQL_PORT -u $MYSQL_USERNAME -p$MYSQL_PASSWORD -D $MYSQL_DATABASE -e "DROP TABLE IF EXISTS job_postings"
#mysql -h $MYSQL_SERVER -P $MYSQL_PORT -u $MYSQL_USERNAME -p$MYSQL_PASSWORD -D $MYSQL_DATABASE -e "DROP TABLE IF EXISTS companies"
